...
import logoImg from '../../../assets/digimedic.png';
import axios from 'axios';
// import { environment } from '../../../environments/environment';
// import { LoginUser, User } from '@water-level/data-transfer-types';
...
export function Login() {
  ...
  const handleLogIn = () =>{
    enqueueSnackbar('In Development: Improving for an enhanced user experience.', { variant: 'error' });
  }
        ...
        {/* <Box className={styles['first_container']}>
          <Grid className={styles['image']}>
            <img
              src={loginImg}
              alt="Background"
              style={{ width: '60vh', height: "67vh", borderTopLeftRadius: "20px", borderBottomLeftRadius: "20px", objectFit: 'cover' }}
            />
          </Grid>
        </Box> */}
